    ...
    <section class="main">
      <div class="container py-5 h-100">
        <div class="table-responsive">
          <h2 class="mb-5" style="color: #4F1F91;"><i class="fas fa-user"></i><i class="fas fa-search"></i> Consultar profesor</h2>
          <!--Buscador para consultar los profesores-->
          <form action="./ConsultarProfesores.php" method="post">
              <div id="input1" class="input-group flex-nowrap">
                  <span class="input-group-text" id=""><i class="fas fa-key"></i></span>
                  <input type="text" autocomplete="off" class="form-control" name="buscador" id="buscador" placeholder="Clave/Nombre/Apellido/Email" aria-label="Username" aria-describedby="addon-wrapping">
              </div>   
          ...
          <?php
            ...
            if(isset($_POST['buscador'])){
              ...
              //Creamos un query para mostrar los registros con esa palabra que inserto en el buscador.
              $sql = "SELECT idProfesor, nombre, apPaterno, apMaterno, email FROM profesor WHERE idProfesor LIKE '%".$clave."%' OR nombre LIKE '%".$clave."%' OR apPaterno LIKE '%".$clave."%' OR apMaterno LIKE '%".$clave."%' OR email LIKE '%".$clave."%'";
