...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../css/Estilos_ListaModificarJuegos.css">
    ...
    <section class="main">
      <div class="container py-5 h-100">
        <div class="table-responsive">
          <h2 class="mb-5" style="color: #4F1F91;"><i class="fas fa-edit"></i> Modificar Juego</h2>
          <table class="table table-striped table-hover">
            ...
            <?php
              ...
              while($filas=mysqli_fetch_assoc($resultado)){
                ...
                //Se crea un botón que los dirige a la página de modificar.
                echo "<td>  <a href='ModificarJuego.php?idJuego=".$filas['idJuego']."'> <button type='button' class='btn btn-danger'>Editar</button> </a> </td>";
                echo "</tr>";
              }
